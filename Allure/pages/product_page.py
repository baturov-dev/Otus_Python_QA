...
from Allure.pages.login_page import LoginPage
from Allure.pages.shopping_cart import ShoppingCart
from Allure.pages.product_comparison_page import ProductComparisonPage
import allure
