...
from Dockerfile.pages.product_page import ProductPage
from Dockerfile.pages.registration_page import RegistrationPage
import allure
...
class MainPage(BasePage):
    ...
    def open_first_product(self):
        self.logger.info("Clicking element: {}".format(self.PRODUCT))
    ...
    def open_registration_page(self):
        ...
        my_account.click()
        self.logger.info("Clicking element: {}".format(self.REGISTER))
